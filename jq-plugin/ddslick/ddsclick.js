        ...
        return this.each(function() {
            ...
            if (!f) {
                ...
                a.each(b.data, function(a, c) {
                    ...
                    m.append("<li>" + '<a class="dd-option">' + 
                            (c.value ? ' <input class="dd-option-value" type="hidden" value="' +
                             c.value + '" />' : "") + (c.imageSrc ? ' <img class="dd-option-image' +
                ...
                if (b.selectText.length > 0 && b.defaultSelectedIndex == null) {
                    ...
                    var o = b.defaultSelectedIndex != null && b.defaultSelectedIndex >= 0 &&
                            b.defaultSelectedIndex < b.data.length ? b.defaultSelectedIndex : 0;
                    g(c, o)
                }
